...
- [ ] **Point `astro.config.mjs` and `public/CNAME` at the real domain.** Both
      currently read `marshallsheds.com` as a placeholder. They drive canonical
...
| Variable | Value |
|---|---|
| `PUBLIC_SITE_URL` | the real origin, e.g. `https://marshallsheds.com` |
